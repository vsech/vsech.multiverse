...
if($iblockID == false)
{
	...
	$dbGroup = CGroup::GetList($by = "", $order = "", Array("STRING_ID" => "content_multiverse_editor"));
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/_index.php", array("EXPORT_IBLOCK_ID" => $iblockID));
?>